  ...
  <div id="f1">
    <div class="mr-container ">
      <div class="shopTitle ">
        ...
        <span class="more ">
          <a href="javascript:void(0)">更多电脑</a>
        </span>
      </div>
    </div>
    <div class="mr-g-fixed floodFive ">
      ...
      <div class="text-two">
        <a href="javascript:void(0)" @click="show"><img src="@/assets/images/computer.jpg"/></a>
        <div class="outer-con ">
          <div class="title ">
            华为电脑
          </div>
...
export default {
  ...
  data: function(){
    return {
      //手机品牌数组
      brands: ['戴尔','清华同方','小米','联想','惠普','华为'],
      //手机核数数组
      cores: ['CPU','显卡','机箱','键盘','鼠标','U盘']
    }
  },
  methods: {
    show: function () {
